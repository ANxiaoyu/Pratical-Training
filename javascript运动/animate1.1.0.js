 ...
 function animate(elem, targetJson, duration, tweenString, callback) {
    ...
    var timer = setInterval(function(){
        ...
        for(var attr in objStepJson) {
            if(attr == "opacity"){
              stepChange = Tween[tweenString](frameCounts,objInitJson[attr], totalChange[attr], totalFrames);
               elem.style[attr] = stepChange + objInitJson[attr];
            }else{
                stepChange=Tween[tweenString](frameCounts, objInitJson[attr], totalChange[attr], totalFrames);
                elem.style[attr] = stepChange + objInitJson[attr] + "px";
            }         
        }
